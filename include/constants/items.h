...
#define TM_START ITEM_TM01
#define TM_END   ITEM_HM08
#define IS_ITEM_TM(item) (item >= TM_START && item <= TM_END)
...
#define ITEM_MAX_MEGA_STONES  (ITEM_PIXIE_PLATE)#define ITEM_EXPANSION_START    (ITEM_PIXIE_PLATE + 1)

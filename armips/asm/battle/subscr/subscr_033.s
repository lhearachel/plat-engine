...
.create "build/move/battle/skill/subscr/subscr_33.s", 0

subscr_033:
    IfMonData                           NOT_EQUAL, BATTLER_ATTACKER, BATTLE_MON_HEAL_BLOCK_TURNS, 0, 54
    SetVarFromVar                       OP_SET, VAR_HP_TEMP, VAR_HIT_DAMAGE
    If                                  EQUAL, VAR_HP_TEMP, 0, 23
    ...
    JumpToSubscript                     2
    Message                             139, TAG_NICK, BATTLER_DEFENDER
    Wait                                
    WaitFrames                          30
    End                                 
    SetVar                              OP_SET, VAR_MOVE_TEMP, 377
    Message                             1054, TAG_NICK_MOVE, BATTLER_ATTACKER, BATTLER_WORKING
    Wait                                
    WaitFrames                          30
    End                                 

...
def writeall():
    ...
    shutil.copy("buildsys/rom.ld", "buildsys/rom_gen.ld")

    if os.path.isfile('buildsys/rom_gen.ld'):
        offsetIni = open('buildsys/rom_gen.ld', 'a')
    else:
        offsetIni = open('buildsys/rom_gen.ld', 'w')
